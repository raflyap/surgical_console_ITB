#include "ros/ros.h"
#include "sensor_handler/encoderInstruction.h"
#include <bits/stdc++.h> 
...
int main(int argc, char **argv)
{
  ...
  ros::NodeHandle n;
  ros::Publisher encInst_pub = n.advertise<sensor_handler::encoderInstruction>("encoder_instruction", 10);
...
//   printf("\ncalibration package : 0x%x\n", calibration_pkg);
  ...
  while (ros::ok())
  {
    sensor_handler::encoderInstruction encInst_msg;
