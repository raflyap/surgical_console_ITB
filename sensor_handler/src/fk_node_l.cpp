...
public:
  ...
  SubscribeAndPublish()
  {
    ...
    pub_dRawPosition = n_.advertise<geometry_msgs::Point>("l_dPosition_raw", 100);
    pub_dRawOrientation = n_.advertise<geometry_msgs::Point>("l_dOrientation_raw", 100);

    //Topic you want to subscribe
    sub_joint = n_.subscribe("l_enc_data", 30, &SubscribeAndPublish::jointCallback, this);
  }
