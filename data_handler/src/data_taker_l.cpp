...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub = n.subscribe("/l_position", 1000, dataCallback);
    ...
    ofstream outFile3 ("/home/epione/console_ws/src/save_data/data_masuk_pos_1_l.txt");
    if (outFile3.is_open())
    {
    ...
    ofstream outFile4 ("/home/epione/console_ws/src/save_data/data_masuk_pos_2_l.txt");
    if (outFile4.is_open())
    {
